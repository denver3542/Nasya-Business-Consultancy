...
class UpdateServiceStageRequest extends FormRequest
{
    /**
    ...
    {
        $serviceStage = $this->route('stage');

        return $serviceStage instanceof ServiceStage && $this->user()->can('update', $serviceStage);
    }
